...
namespace BlogManagement.Controllers
{
    public class AccountController : Controller
    {
        ...
        {
            uow = new UnitOfWork(new Entities.BlogDBContext());
        }
        ...
        {
            Entities.Account acc = uow.accountRepository.getByEmail(model.Email);
            if (acc != null)
        ...
        {
            Entities.Account acc = uow.accountRepository.getByEmail(email);
            if(acc != null)
